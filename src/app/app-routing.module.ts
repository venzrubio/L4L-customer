...
const routes: Routes = [
  ...
  {
    path: 'store-infos',
    loadChildren: () => import('./pages/store-infos/store-infos.module').then( m => m.StoreInfosPageModule)
  },
  {
    path: 'stores-tab',
    loadChildren: () => import('./pages/stores-tab/stores-tab.module').then( m => m.StoresTabPageModule)
  },
  ...
  {
    path: 'calendar2',
    loadChildren: () => import('./pages/calendar2/calendar2.module').then( m => m.Calendar2PageModule)
  },
  {
