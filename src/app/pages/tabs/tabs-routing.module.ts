    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            path: 'store-info',
            loadChildren: () =>
              import('../store-info/store-info.module').then(m => m.StoreInfoPageModule)
          },
          {
          ...
          },
          {
            path: 'select-time',
            loadChildren: () =>
              import('../select-time/select-time.module').then(m => m.SelectTimePageModule)
          }
        ]
      },
      {
        ...
        children: [
          {
            path: '',
            loadChildren: () =>
              import('../chats/chats-routing.module').then(m => m.ChatsPageRoutingModule)
          }
        ],
        canActivate: [AuthGuard]
      },
        ...
        children: [
          {
            path: '',
            loadChildren: () =>
              import('../calendar/calendar-routing.module').then(m => m.CalendarPageRoutingModule)
          }
        ],
        canActivate: [AuthGuard]
      },
